...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Short Trip Photos </h1>
      </div><!-- /.col --><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>#No</th>
                <th>Short Trip Title</th>
                <th>Photo</th>
              </tr>
            </thead>
            <tbody>
              <?php $data = $dbh->query("SELECT * FROM gallery_photos g, short_trips_packages t WHERE g.tour_id = t.stp_id");
              $x = 1;
        ...
        <div class="modal-body">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="email">Short Trip Destination</label>
                <select class="form-control" name="tour_id" required>
                  ...
                  while ($rx = $tox->fetch(PDO::FETCH_OBJ)) { ?>
                    <option value="<?=$rx->short_trips;?>"><?=$rx->st_name; ?></option>
                  <?php } ?>
                </select>
              </div>

              <div class="form-group">
                <label for="tour_photo">Short Trip Package Photo</label>
