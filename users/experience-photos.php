...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Experience Photos </h1>
      </div><!-- /.col --><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php $data = $dbh->query("SELECT * FROM gallery_photos g, experience_packages t WHERE g.tour_id = t.experience_id");
              $x = 1;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header pink-purple p-4">
          <h4 class="modal-title">New Experience Photo</h4>
        ...
        <div class="modal-body">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="email">Experience Destination</label>
                <select class="form-control" name="tour_id" required>
                  <option value="">--select Experience Safari--</option>
                  <?php $tox = $dbh->query("SELECT * FROM experience_packages ");
                  while ($rx = $tox->fetch(PDO::FETCH_OBJ)) { ?>
                    <option value="<?=$rx->experience_id;?>"><?=$rx->experience_title; ?></option>
                  <?php } ?>
                </select>
              </div>

              <div class="form-group">
                <label for="tour_photo">Experience Package Photo</label>
