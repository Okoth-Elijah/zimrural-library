...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Destination Photos </h1>
      </div><!-- /.col --><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php $data = $dbh->query("SELECT * FROM gallery_photos g, destination_packages t WHERE g.tour_id = t.destination_id");
              $x = 1;
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="tour_id" required>
                  ...
                  <?php $tox = $dbh->query("SELECT * FROM destination_packages ");
                  while ($rx = $tox->fetch(PDO::FETCH_OBJ)) { ?>
                    <option value="<?=$rx->destination_id;?>"><?=$rx->destination_title; ?></option>
                  <?php } ?>
                </select>
              </div>
