...
switch(DB_URL){
	case 'localhost':
		...
		defined ("DB_NAME") or define("DB_NAME", "zw_internet_in_a_box");
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/zimrural-library.org');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/zimrural-library.org/admin-dash');
	break;

	case 'https://www.zimrural-library.org': 
	    defined ("DB_SERVER") or define("DB_SERVER", 'localhost');
		defined ("DB_USER") or define("DB_USER", "zfuexqvm_libuser");
		defined ("DB_PASS") or define("DB_PASS", "iz{6436o1GgP");
		defined ("DB_NAME") or define("DB_NAME", "zfuexqvm_libdb");
		defined ("SITE_URL") or define("SITE_URL", 'https://www.zimrural-library.org');
		defined ("HOME_URL") or define("HOME_URL", 'https://www.zimrural-library.org/admin-dash');
	break;
